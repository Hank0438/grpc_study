...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fhelloworld_2eproto = {
  false, false, 236, descriptor_table_protodef_proto_2fhelloworld_2eproto, "proto/helloworld.proto", 
  &descriptor_table_proto_2fhelloworld_2eproto_once, nullptr, 0, 2,
  schemas, file_default_instances, TableStruct_proto_2fhelloworld_2eproto::offsets,
  file_level_metadata_proto_2fhelloworld_2eproto, file_level_enum_descriptors_proto_2fhelloworld_2eproto, file_level_service_descriptors_proto_2fhelloworld_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_proto_2fhelloworld_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_proto_2fhelloworld_2eproto);
  return descriptor_table_proto_2fhelloworld_2eproto.file_level_metadata[index];
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_proto_2fhelloworld_2eproto(&descriptor_table_proto_2fhelloworld_2eproto);
namespace helloworld {
