...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_proto_2fhelloworld_2eproto_metadata_getter(int index);
...
class HelloRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_proto_2fhelloworld_2eproto_metadata_getter(kIndexInFileMessages);
  }
